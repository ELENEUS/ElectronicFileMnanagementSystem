  ...
  <div id="sidebar">
    ...
    <ul class="nav">
      <li>
       ...
       <li>
        <a href="http://localhost/document/actionpage.php">
          <span class="glyphicon glyphicon-email" > </span></i>VIEW MAILS 
        </a>
      </li>
       <li>
        <a href="http://localhost/document/upload/uploadedfile.php">
...
<body>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
			...
			<tr>
				...
				<td><a href="deleteuploadedfile.php?del_d=<?php echo$row['id'];?>" class="btn btn-danger btn_del" ><span class="glyphicon glyphicon-trash"> </span>Delete </a></td>
			</tr>
			<?php }?>
		</table>
	</div>
