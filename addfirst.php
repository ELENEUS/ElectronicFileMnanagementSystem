  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <p>
        ...
        <code><CENTER>ADD  GOVERNMENT REGISTORY OFFICERS </CENTER></code>
        <BR>
        <center>
        <table class="table table-striep" style="width: 50%;">
          <form action="addfirst.php" method="post">
            ...
            <tr><td>first name</td><td><input type="text" name="firstname" placeholder="first name" class="form-control"></td></tr>
            <tr><td>last name</td><td><input type="text" name="lastname" placeholder="last name" class="form-control"></td></tr>
            <tr><td>Email</td><td><input type="email" name="email" placeholder="email address" class="form-control"></td></tr>
            <tr><td>User type</td><td><select name="usertype" class="form-control"><option disabled=" disabled" selected> Select user type</option>
            ...
            <tr><td>Phone</td><td><input type="number" name="phone" placeholder="phone number" class="form-control"></td></tr>
            <tr><td>password</td><td><input type="password" name="password" placeholder="password" class="form-control"></td></tr>
            <tr><td>confrim password</td><td><input type="password" name="password1" placeholder="confrim password" class="form-control"></td></tr>
