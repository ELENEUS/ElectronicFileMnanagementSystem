...
<body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse">
            <ul class="nav">
                ...
                <li class="active"><a href="adduser.php">DASHBORD</a></li>
    ...
    <div id="mainsection">
        <div class="main">
           <button class="btn btn-success"><i class="icon-upload icon-white"></i><a href="addfile2.php">Add File</a></button>
           <hr>
	    <div id="container">
		<div class="form_head">Add File</div><hr>
		    ...
		    <form method="post" action="addfile2.php?cat=<?=$filtername?>" enctype="multipart/form-data">
			<div class="control-group">
		...
		if(isset($_FILES['files'])){
			...
			if($cat_name==""){
			    ...
			    header('Refresh: 1;url=addfile2.php');
			}
			else{
			    $count=0;
			    ...
			    header('Refresh: 2;url=addfile2.php');
			}
		}
		?>
	    </div>
