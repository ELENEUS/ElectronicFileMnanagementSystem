  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <p>
        ...
        <code><CENTER>ADD USER TYPE </CENTER></code>
        <center>
        <table class="table table-striep" style="width: 70%;">
          <form action="admin.php" method="post">
            <tr><th>ID</th><TH>USER TYPE</TH><th>ACTION</th></tr>
            <tr><td><input type="text" name="id" placeholder="id" class="form-control" required></td>
              <td><input type="text" name="user" placeholder="user type" class="form-control" required></td><td>
            ...
            <?php  while ( $row = $exc->fetch_array(MYSQLI_BOTH) ){
              ...
              <tr><td> <?php  echo "$row[id]"; ?></td><td> <?php  echo "$row[usertype]"; ?></td>
                <!--<td><a href="delete.php?del_d=<?php echo$row['id'];?>" class="btn btn-danger btn_del" >
