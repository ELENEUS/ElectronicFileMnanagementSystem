<?php
 ...
 // move_uploaded_file($_FILES["file"]["name"], $dir);
  ...
  $insert = "INSERT INTO `templemsg`(`reciever`, `message`) VALUES ('$id','$user')";
  ...
  <div id="sidebar">
   ...
   <ul class="nav">
      <li>
       ...
       <li>
        <a href="upload/uploadedfile.php">
          ...
          <form action="actionpage.php" method="post" enctype="multipart/form-data">
            ...
            <?php  while ( $row = $exc->fetch_array(MYSQLI_BOTH) ){
              ...
              <tr><td> <?php  echo "$row[reciever]"; ?></td>
                  ...
                  <td> </td>
                  <td><a href="delete5.php?del_d=<?php echo$row['id'];?>" class="btn btn-danger btn_del" ><span class="glyphicon glyphicon-trash"> </span>Delete </a></td>
              </tr>
              <?PHP } ?>
